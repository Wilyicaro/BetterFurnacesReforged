...
public class ModObjects {
    ...
    public static final RegistrySupplier<ForgeBlock> EXTREME_FORGE = BLOCK_ITEMS.register(SmeltingBlocks.EXTREME_FORGE.getName(), () -> new ForgeBlock(BlockBehaviour.Properties.copy(Blocks.NETHERITE_BLOCK).strength(30.0F, 6000.0F), defaultItemProperties(), Config.extremeTierSpeed));
