...
public class ModObjectsUF {
    ...
    public static final RegistrySupplier<SmeltingBlock> AMETHYST_FURNACE = BLOCK_ITEMS.register(SmeltingBlocks.AMETHYST_FURNACE.getName(), () -> new SmeltingBlock(BlockBehaviour.Properties.copy(Blocks.PURPLE_STAINED_GLASS).strength(20.0F, 30.0F),defaultItemProperties(), Config.amethystTierSpeed));

    public static final RegistrySupplier<SmeltingBlock> PLATINUM_FURNACE = BLOCK_ITEMS.register(SmeltingBlocks.PLATINUM_FURNACE.getName(), () -> new SmeltingBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(30.0F, 60.0F),defaultItemProperties(), Config.platinumTierSpeed));
