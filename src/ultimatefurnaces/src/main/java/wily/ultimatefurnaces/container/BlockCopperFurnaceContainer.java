...
public class BlockCopperFurnaceContainer extends BlockFurnaceContainerBase {
    ...
    public BlockCopperFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(wily.ultimatefurnaces.init.Registration.COPPER_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
    }
    ...
    public BlockCopperFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player, ContainerData fields) {
        super(wily.ultimatefurnaces.init.Registration.COPPER_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player, fields);
    }


    @Override
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(te.getLevel(), te.getBlockPos()), playerEntity, Registration.COPPER_FURNACE.get());
    }
}
