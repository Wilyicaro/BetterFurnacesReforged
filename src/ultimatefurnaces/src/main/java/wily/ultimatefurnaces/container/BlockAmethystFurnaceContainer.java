...
public class BlockAmethystFurnaceContainer extends BlockFurnaceContainerBase {
    ...
    public BlockAmethystFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(RegistrationUF.AMETHYST_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
    }

    public BlockAmethystFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player, ContainerData fields) {
