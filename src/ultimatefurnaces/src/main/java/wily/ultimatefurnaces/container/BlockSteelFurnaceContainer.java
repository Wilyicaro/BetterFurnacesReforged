...
public class BlockSteelFurnaceContainer extends BlockFurnaceContainerBase {
    ...
    public BlockSteelFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(RegistrationUF.STEEL_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
    }

    public BlockSteelFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player, ContainerData fields) {
