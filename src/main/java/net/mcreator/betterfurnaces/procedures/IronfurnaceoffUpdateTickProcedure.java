...
import net.mcreator.betterfurnaces.item.NetherhotUpgradeItem;
import net.mcreator.betterfurnaces.item.GoldUpgradeItem;
...
import net.mcreator.betterfurnaces.item.ExtremeUpgradeItem;
import net.mcreator.betterfurnaces.item.DiamondUpgradeItem;
import net.mcreator.betterfurnaces.item.ColorupgradeItem;
...
public class IronfurnaceoffUpdateTickProcedure extends BetterfurnacesreforgedModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((furnacetm) <= 0)) {
			...
			} else if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == GoldfurnaceoffBlock.block.getDefaultState()
					.getBlock())) {
		...
		if (((((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == IronfurnaceoffBlock.block.getDefaultState().getBlock())
				|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == NetherhotFurnaceBlock.block.getDefaultState()
						...
						|| ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ExtremeFurnaceBlock.block.getDefaultState()
								.getBlock())))
				|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == GoldfurnaceoffBlock.block.getDefaultState()
						.getBlock())
		...
		} else if ((((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == IronfurnaceoffBlock.block.getDefaultState()
				.getBlock())
				|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == NetherhotFurnaceBlock.block.getDefaultState()
						.getBlock())
						|| ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ExtremeFurnaceBlock.block.getDefaultState()
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == IronfurnaceoffBlock.block.getDefaultState().getBlock())) {
			if ((new ItemStack(GoldUpgradeItem.block, (int) (1)).getItem() == (new Object() {
				...
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = GoldfurnaceoffBlock.block.getDefaultState();
		...
		if (((new ItemStack(ColorupgradeItem.block, (int) (1)).getItem() == (new Object() {
			...
			if ((((new Object() {
				...
				try {
					BlockState _state = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z),
							_state.with((IntegerProperty) _state.getBlock().getStateContainer().getProperty("age"), 4), 3);
				} catch (Exception e) {
				}
			} else if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				try {
					BlockState _state = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z),
							_state.with((IntegerProperty) _state.getBlock().getStateContainer().getProperty("age"), 5), 3);
				} catch (Exception e) {
				}
			} else if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				try {
					BlockState _state = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z),
							_state.with((IntegerProperty) _state.getBlock().getStateContainer().getProperty("age"), 6), 3);
				} catch (Exception e) {
				}
			} else if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				try {
					BlockState _state = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z),
							_state.with((IntegerProperty) _state.getBlock().getStateContainer().getProperty("age"), 7), 3);
				} catch (Exception e) {
				}
			} else if ((((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				try {
					BlockState _state = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z),
							_state.with((IntegerProperty) _state.getBlock().getStateContainer().getProperty("age"), 8), 3);
				} catch (Exception e) {
				}
			}
			if ((((new Object() {
				...
				try {
					BlockState _state = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z),
							_state.with((IntegerProperty) _state.getBlock().getStateContainer().getProperty("age"), 9), 3);
				} catch (Exception e) {
				}
			}
		} else {
