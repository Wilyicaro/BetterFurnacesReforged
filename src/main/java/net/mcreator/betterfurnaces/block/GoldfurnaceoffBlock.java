...
public class GoldfurnaceoffBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:goldfurnaceoff")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:goldfurnaceoff")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public GoldfurnaceoffBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 2);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("goldfurnaceoff"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("goldfurnaceoff");
		}
		@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("goldfurnaceoff");
		}
