...
import net.mcreator.betterfurnaces.procedures.OpencolorupgradeProcedure;
import net.mcreator.betterfurnaces.procedures.ColorupgradeItemInInventoryTickProcedure;
import net.mcreator.betterfurnaces.itemgroup.BetterFurnacesReforgedItemGroup;
import net.mcreator.betterfurnaces.gui.ColorupgradeguiGuiWindow;
...
public class ColorupgradeItem extends BetterfurnacesreforgedModElements.ModElement {
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof ColorupgradeguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ColorupgradeguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
