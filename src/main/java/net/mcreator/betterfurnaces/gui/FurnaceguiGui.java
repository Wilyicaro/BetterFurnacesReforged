...
public class FurnaceguiGui extends BetterfurnacesreforgedModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public FurnaceguiGui(BetterfurnacesreforgedModElements instance) {
		super(instance, 22);
	...
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FurnaceguiGuiWindow::new));
	}
