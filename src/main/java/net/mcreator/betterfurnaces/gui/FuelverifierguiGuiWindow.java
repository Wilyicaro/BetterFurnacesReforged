...
@OnlyIn(Dist.CLIENT)
public class FuelverifierguiGuiWindow extends ContainerScreen<FuelverifierguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	...
	private static final ResourceLocation texture = new ResourceLocation("betterfurnacesreforged:textures/fuelverifiergui.png");
	@Override
