...
@OnlyIn(Dist.CLIENT)
public class CobgeneratorguiGuiWindow extends ContainerScreen<CobgeneratorguiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public CobgeneratorguiGuiWindow(CobgeneratorguiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
