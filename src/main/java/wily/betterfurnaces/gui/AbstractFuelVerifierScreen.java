...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractFuelVerifierScreen<T extends FuelVerifierContainer> extends ContainerScreen<T> {
    ...
    public static class FuelVerifierScreen extends AbstractFuelVerifierScreen<FuelVerifierContainer> {
        public FuelVerifierScreen(FuelVerifierContainer container, PlayerInventory inv, ITextComponent name) {
