...
@OnlyIn(Dist.CLIENT)
public abstract class BlockInventoryScreen<T extends Container> extends ContainerScreen<T> {


    public BlockInventoryScreen(T p_97741_, PlayerInventory p_97742_, ITextComponent p_97743_) {
    ...
    protected void renderGuiItem(ItemStack stack, int p_191962_2_, int p_191962_3_, float scaleX, float scaleY) {
        ...
        this.itemRenderer.render(stack, ItemCameraTransforms.TransformType.GUI, false, matrixstack, irendertypebuffer$impl, 15728880, OverlayTexture.NO_OVERLAY, this.itemRenderer.getModel(stack, (World)null, (LivingEntity)null));
