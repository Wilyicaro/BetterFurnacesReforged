...
@OnlyIn(Dist.CLIENT)
public class UpgradeColorScreen extends AbstractUpgradeScreen<ContainerColorUpgrade> {
    ...
    public UpgradeColorScreen(ContainerColorUpgrade container, PlayerInventory inv, ITextComponent name) {
