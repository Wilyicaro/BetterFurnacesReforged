...
public abstract class BlockCobblestoneGeneratorScreen<T extends BlockCobblestoneGeneratorContainer> extends BlockInventoryScreen<T> {
    ...
    private List<CobblestoneGeneratorRecipes> recipes(){
        ...
        return  BlockCobblestoneGeneratorTile.recipes == null ?  Objects.requireNonNull(getMenu().te.getLevel().getRecipeManager().getAllRecipesFor(Registration.COB_GENERATION_RECIPE)) : BlockCobblestoneGeneratorTile.recipes;
    }
