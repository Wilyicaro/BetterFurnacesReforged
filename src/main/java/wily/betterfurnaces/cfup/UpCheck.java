    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        if(Minecraft.getInstance().player != null){
            ...
            if(UpCheck.checkFailed){
                ...
                player.displayClientMessage(Component.Serializer.fromJson(I18n.get(BetterFurnacesReforged.MOD_ID+".update.version", BetterFurnacesReforged.MC_VERSION + "-release" + BetterFurnacesReforged.VERSION, UpCheck.updateVersionString)), false);
