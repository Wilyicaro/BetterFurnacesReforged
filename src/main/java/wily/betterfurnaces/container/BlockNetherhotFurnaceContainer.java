...
public class BlockNetherhotFurnaceContainer extends BlockFurnaceContainerBase {
    ...
    public BlockNetherhotFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.NETHERHOT_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
    }

    public BlockNetherhotFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player, ContainerData fields) {
