...
public class SlotFuel extends Slot {
    ...
    public boolean mayPlace(ItemStack stack) {
        return BlockEntitySmeltingBase.isItemFuel(stack) || (stack.getCapability(CapabilityEnergy.ENERGY).isPresent() && be.hasUpgrade(Registration.ENERGY.get())) || isContainer(stack) ;
    }
