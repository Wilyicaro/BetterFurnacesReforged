...
public abstract class AbstractFuelVerifierScreen<T extends AbstractFuelVerifierMenu> extends AbstractContainerScreen<T> {
    ...
    public static class BlockFuelVerifierScreen extends AbstractFuelVerifierScreen<AbstractFuelVerifierMenu> {
        public BlockFuelVerifierScreen(AbstractFuelVerifierMenu container, Inventory inv, Component name) {
    ...
    protected void renderLabels(PoseStack matrix, int mouseX, int mouseY) {
        ...
        Component burntime = new TranslatableComponent("gui.betterfurnacesreforged.fuel.melts").append(new TextComponent(String.valueOf(((AbstractFuelVerifierMenu) this.getMenu()).getBurnTime()))).append( new TranslatableComponent("gui.betterfurnacesreforged.fuel.items"));
