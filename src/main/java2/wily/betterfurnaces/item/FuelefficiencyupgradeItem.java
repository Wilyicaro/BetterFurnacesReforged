...
public class FuelefficiencyupgradeItem extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:fuel_efficiency_upgrade")
	public static final Item block = null;
	public FuelefficiencyupgradeItem(BetterfurnacesreforgedModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fuel_efficiency_upgrade");
		}
