...
public class OreprocessingupgradeItem extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:ore_processing_upgrade")
	public static final Item block = null;
	public OreprocessingupgradeItem(BetterfurnacesreforgedModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ore_processing_upgrade");
		}
