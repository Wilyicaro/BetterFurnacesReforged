...
public class LiquidfuelupgradeItem extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:liquid_fuel_upgrade")
	public static final Item block = null;
	public LiquidfuelupgradeItem(BetterfurnacesreforgedModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("liquid_fuel_upgrade");
		}
