...
public class ExtremeFurnaceBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:extreme_furnace")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:extreme_furnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ExtremeFurnaceBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 5);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("extreme_furnace"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("extreme_furnace");
		}
		@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Extreme Furnace");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("extreme_furnace");
		}
