...
public class IronConductorBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:iron_conductor_block")
	public static final Block block = null;
	public IronConductorBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("iron_conductor_block");
		}
