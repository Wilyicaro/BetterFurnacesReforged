...
import wily.betterfurnaces.procedures.CobgeneratorproProcedure;
import wily.betterfurnaces.itemgroup.BetterFurnacesReforgedItemGroup;
import wily.betterfurnaces.gui.CobgeneratorGui;
...
public class CobblestonegeneratorBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:cobblestone_generator")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:cobblestone_generator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CobblestonegeneratorBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 71);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(STATE, Integer.valueOf(0)));
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new CobgeneratorGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new CobgeneratorGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
