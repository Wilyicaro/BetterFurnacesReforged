...
public class GoldFurnaceBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:gold_furnace")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:gold_furnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public GoldFurnaceBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 2);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("gold_furnace"));
		}
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Gold Furnace");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("gold_furnace");
		}
