...
public class NetherhotConductorBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:netherhot_conductor_block")
	public static final Block block = null;
	public NetherhotConductorBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("netherhot_conductor_block");
		}
