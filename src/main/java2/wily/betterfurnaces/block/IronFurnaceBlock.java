...
public class IronFurnaceBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:iron_furnace")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:iron_furnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public IronFurnaceBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 1);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("iron_furnace"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3.5f, 20f).setLightLevel(s -> 0).harvestLevel(1)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Iron Furnace");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("iron_furnace");
		}
