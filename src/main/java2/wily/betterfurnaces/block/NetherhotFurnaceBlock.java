...
import wily.betterfurnaces.procedures.IronfurnaceoffUpdateTickProcedure;
import wily.betterfurnaces.itemgroup.BetterFurnacesReforgedItemGroup;
import wily.betterfurnaces.gui.FurnaceGui;
...
public class NetherhotFurnaceBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:netherhot_furnace")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:netherhot_furnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public NetherhotFurnaceBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 4);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("netherhot_furnace"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public static final IntegerProperty STATE = IntegerProperty.create("color",0,9);
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(4.5f, 20f).setLightLevel(s -> 0).harvestLevel(1)
			...
			setRegistryName("netherhot_furnace");
		}
		@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Netherhot Furnace");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new FurnaceGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("netherhot_furnace");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new FurnaceGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
