...
import wily.betterfurnaces.procedures.UpdatetickforgesProcedure;
import wily.betterfurnaces.itemgroup.BetterFurnacesReforgedItemGroup;
import wily.betterfurnaces.gui.ForgeGui;
...
public class ExtremeForgeBlock extends BetterfurnacesreforgedModElements.ModElement {
	@ObjectHolder("betterfurnacesreforged:extreme_forge")
	public static final Block block = null;
	@ObjectHolder("betterfurnacesreforged:extreme_forge")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ExtremeForgeBlock(BetterfurnacesreforgedModElements instance) {
		super(instance, 22);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("extreme_forge"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(6f, 50f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH).with(WATERLOGGED, false).with(ON, Boolean.valueOf(false)));
			setRegistryName("extreme_forge");
		}
		@OnlyIn(Dist.CLIENT)
		@Override
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			super.tick(state, world, pos, random);
			{
				...
				UpdatetickforgesProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Extreme Forge");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new ForgeGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("extreme_forge");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new ForgeGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
