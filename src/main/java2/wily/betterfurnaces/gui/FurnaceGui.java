...
import wily.betterfurnaces.item.AdmupgradeItem;
...
public class FurnaceGui extends BetterfurnacesreforgedModElements.ModElement {
	protected IIntArray fields;
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public FurnaceGui(BetterfurnacesreforgedModElements instance) {
		super(instance, 22);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("furnacegui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FurnaceGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 54, 18) {
				@Override
			...
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 8, 54) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ColorupgradeItem.block, (int) (1)).getItem() == stack.getItem() || new ItemStack(AdmupgradeItem.block, (int) (1)).getItem() == stack.getItem() || new ItemStack(LiquidfuelupgradeItem.block, (int) (1)).getItem() == stack.getItem() || new ItemStack(GoldUpgradeItem.block, (int) (1)).getItem() == stack.getItem() || new ItemStack(DiamondUpgradeItem.block, (int) (1)).getItem() == stack.getItem() || new ItemStack(NetherhotUpgradeItem.block, (int) (1)).getItem() == stack.getItem() || new ItemStack(ExtremeUpgradeItem.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
